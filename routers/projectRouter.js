...
router.get("/getAllProjects",fun.verifyToken,fun.checkRole(["admin","viewer","editor"]),projectController.getAllProjects);
router.post("/updateProject",fun.verifyToken,fun.checkRole(["admin"]),projectController.updateProject);
router.get("/getProjectsByClient",fun.verifyToken,fun.checkRole(["admin","editor"]),projectController.getProjectsByClient);
...
router.get("/getProjects",fun.optionalVerifyToken,projectController.getProjects);
