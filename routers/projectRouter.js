...
router.get("/getAllProjects",fun.verifyToken,fun.checkRole(["admin"]),projectController.getAllProjects);
router.post("/updateProject",fun.verifyToken,fun.checkRole(["admin"]),projectController.updateProject);
router.get("/getProjectsByClient",fun.verifyToken,fun.checkRole(["admin"]),projectController.getProjectsByClient);
